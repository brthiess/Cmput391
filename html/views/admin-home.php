...
<body>
	...
	<div class="col-md-4 top-buffer">
		<a href="admin-search.php"><button class="btn btn-info center-block purple-btn large-btn"><span class="glyphicon glyphicon-search"  aria-hidden="true"></span> Search Diagnosis</button></a>
	</div>
